...
#Pages page
@pages.route('/pages/blog_list')
@login_required
def blog_list():
    return render_template('pages/pages/pages-blog-list.html')

@pages.route('/pages/blog_grid')
@login_required
def blog_grid():
    return render_template('pages/pages/pages-blog-grid.html')

@pages.route('/pages/blog_overview')
@login_required
def blog_overview():
    return render_template('pages/pages/pages-blog-overview.html')
